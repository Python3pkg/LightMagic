...
# J.join(C, fields=C.get_model_fields(), on={(C, 'id'): (B, 'id'), (C, 'geo'): (B, 'geo_id')})
J.join(C, fields=C.get_model_fields(), on={(C, 'id'): (B, 'id')})
# J.join(D, fields=D.get_model_fields(), on={(D, 'id'): (B, 'id'), (D, 'geo'): (C, 'id')})
J.run()
